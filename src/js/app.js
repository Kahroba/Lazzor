    ...
    app.controller("trailController", function ($scope, $routeParams, $http) {
        ...
        function error() {
            $scope.trail = {
                ...
                SosService: "حلال احمر(امداد کوهستان) 112"
            };
        };
    });
