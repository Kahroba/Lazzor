...
// Pano2VR 5.0.2/15080
// Filename: damavand skin.ggsk
// Generated يكشنبه اوت 7 03:57:40 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._marker_title2__text.innerHTML="\u0642\u0644\u0647 \u062f\u0645\u0627\u0648\u0646\u062f";
		...
		this._marker_title1__text.innerHTML="\u062c\u0627\u0646\u067e\u0646\u0627\u0647 \u0633\u06cc\u0645\u0631\u063a";
		...
		this._marker_node59.ggMarkerNodeId='{node59}';
		...
		this._maps.appendChild(this._marker_node59);
		...
		this._maps.appendChild(this._marker_node55);
		...
		this._marker_node40=document.createElement('div');
		this._marker_node40.ggMarkerNodeId='{node40}';
		nodeMarker.push(this._marker_node40);
		this._marker_node40.ggId="marker_node40";
		this._marker_node40.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._marker_node40.ggVisible=true;
		this._marker_node40.className='ggskin ggskin_mark ';
		this._marker_node40.ggType='mark';
		hs ='';
		hs+='height : 5px;';
		hs+='left : 248px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 5px;';
		this._marker_node40.setAttribute('style',hs);
		this._marker_node40.style[domTransform + 'Origin']='50% 50%';
		me._marker_node40.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		me._marker_node40.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
			if (hs.charAt(0)=='{') {
				return hs.substr(1, hs.length - 2);
			}
		...
		this._marker_node40.onclick=function () {
			me.player.openNext('{node40}');
		}
		this._marker_node40.onmouseover=function () {
			me._marker_title2.style[domTransition]='none';
			me._marker_title2.style.visibility=(Number(me._marker_title2.style.opacity)>0||!me._marker_title2.style.opacity)?'inherit':'hidden';
			me._marker_title2.ggVisible=true;
		}
		this._marker_node40.onmouseout=function () {
			me._marker_title2.style[domTransition]='none';
			me._marker_title2.style.visibility='hidden';
			me._marker_title2.ggVisible=false;
		}
		this._marker_node40.ggUpdateConditionNodeChange=function () {
				me._marker_node40__normal.ggNodeChangeMain();
				me._marker_node40__active.ggNodeChangeMain();
		}
		this._marker_node40.ggUpdatePosition=function () {
		}
		this._marker_node40.ggNodeChange=function () {
			me._marker_node40.ggUpdateConditionNodeChange();
		}
		this._maps.appendChild(this._marker_node40);
		...
		this._marker_node35.style[domTransform + 'Origin']='50% 50%';
		me._marker_node35.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		me._marker_node35.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
			if (hs.charAt(0)=='{') {
				return hs.substr(1, hs.length - 2);
			}
		...
		this._marker_node35.ggUpdateConditionNodeChange=function () {
				me._marker_node35__normal.ggNodeChangeMain();
				me._marker_node35__active.ggNodeChangeMain();
		}
		this._marker_node35.ggUpdatePosition=function () {
		}
		this._marker_node35.ggNodeChange=function () {
			me._marker_node35.ggUpdateConditionNodeChange();
		}
		this._maps.appendChild(this._marker_node35);
		...
		this._marker_node59__normal=new SkinElement_marker_normal0_Class(this,this._marker_node59);
		this._marker_node59__normal.style.visibility='inherit';
		this._marker_node59__normal.style.left='-38px';
		this._marker_node59__normal.style.top='-16px';
		this._marker_node59.ggMarkerNormal=this._marker_node59__normal;
		this._marker_node59__active=new SkinElement_marker_active0_Class(this,this._marker_node59);
		this._marker_node59__active.style.visibility='hidden';
		this._marker_node59__active.style.left='-57px';
		this._marker_node59__active.style.top='-24px';
		...
		this._marker_node55__normal=new SkinElement_marker_normal0_Class(this,this._marker_node55);
		this._marker_node55__normal.style.visibility='inherit';
		this._marker_node55__normal.style.left='-38px';
		this._marker_node55__normal.style.top='-16px';
		this._marker_node55.ggMarkerNormal=this._marker_node55__normal;
		this._marker_node55__active=new SkinElement_marker_active0_Class(this,this._marker_node55);
		this._marker_node55__active.style.visibility='hidden';
		this._marker_node55__active.style.left='-57px';
		this._marker_node55__active.style.top='-24px';
		...
		this._marker_node40__normal=new SkinElement_marker_normal0_Class(this,this._marker_node40);
		this._marker_node40__normal.style.visibility='inherit';
		this._marker_node40__normal.style.left='-38px';
		this._marker_node40__normal.style.top='-16px';
		this._marker_node40.ggMarkerNormal=this._marker_node40__normal;
		this._marker_node40__active=new SkinElement_marker_active0_Class(this,this._marker_node40);
		this._marker_node40__active.style.visibility='hidden';
		this._marker_node40__active.style.left='-57px';
		this._marker_node40__active.style.top='-24px';
		this._marker_node40.ggMarkerActive=this._marker_node40__active;
		if (this._marker_node40.firstChild) {
			this._marker_node40.insertBefore(this._marker_node40__active,this._marker_node40.firstChild);
		} else {
			this._marker_node40.appendChild(this._marker_node40__active);
		}
		if (this._marker_node40.firstChild) {
			this._marker_node40.insertBefore(this._marker_node40__normal,this._marker_node40.firstChild);
		} else {
			this._marker_node40.appendChild(this._marker_node40__normal);
		}
		this._marker_node35__normal=new SkinElement_marker_normal0_Class(this,this._marker_node35);
		this._marker_node35__normal.style.visibility='inherit';
		this._marker_node35__normal.style.left='-38px';
		this._marker_node35__normal.style.top='-16px';
		this._marker_node35.ggMarkerNormal=this._marker_node35__normal;
		this._marker_node35__active=new SkinElement_marker_active0_Class(this,this._marker_node35);
		this._marker_node35__active.style.visibility='hidden';
		this._marker_node35__active.style.left='-57px';
		this._marker_node35__active.style.top='-24px';
		...
		this._marker_node31__normal=new SkinElement_marker_normal0_Class(this,this._marker_node31);
		this._marker_node31__normal.style.visibility='inherit';
		this._marker_node31__normal.style.left='-38px';
		this._marker_node31__normal.style.top='-16px';
		this._marker_node31.ggMarkerNormal=this._marker_node31__normal;
		this._marker_node31__active=new SkinElement_marker_active0_Class(this,this._marker_node31);
		this._marker_node31__active.style.visibility='hidden';
		this._marker_node31__active.style.left='-57px';
		this._marker_node31__active.style.top='-24px';
	...
	this.changeActiveNode=function(id) {
		...
		me._marker_node40.ggNodeChange();
		me._marker_node35.ggNodeChange();
